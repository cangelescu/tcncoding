...
{
    private List<List<ModulatorSignal>> data;
    ...
    public ModulatorVizualizatorConverter(List<List<ModulatorSignal>> _data, String _description, Color _chartColor)
    {
	data = _data;
	...
	for (List<ModulatorSignal> clms: data)
	    out.add(new DataVizualizatorProvider(clms, Signal.SignalType.MODULATOR, description, chartColor));
	return out;
    }
}
