...
public class SignalFunction implements MathToolsFunction
{
    ...
    public SignalFunction(double freq, double ampl, double ph)
    {
        this.frequency = freq;
        this.amplitude = ampl;
        this.phase = ph;
    ...
    public SignalFunction(double freq, double ampl, double ph, double ns)
    {
        this.frequency = freq;
        this.amplitude = ampl;
        this.phase = ph;
    ...
    public SignalFunction(double freq, double ampl, double ph, double ns, double efreq, double eampl, double eph)
    {
        this.frequency = freq;
        this.amplitude = ampl;
        this.phase = ph;
